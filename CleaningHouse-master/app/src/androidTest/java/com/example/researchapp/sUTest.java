...
public class sUTest {
    ...
    public void suTest() {
        ...
        onView(withId(R.id.imageview_account_profile)).check(matches(isClickable()));
        onView(withId(R.id.makeAccBtn)).check(matches(isDisplayed()));
        onView(withId(R.id.makeAccBtn)).check(matches(isEnabled()));
        onView(withId(R.id.makeAccBtn)).check(matches(isClickable()));
        onView(withId(R.id.roleToggle)).check(matches(isDisplayed()));
