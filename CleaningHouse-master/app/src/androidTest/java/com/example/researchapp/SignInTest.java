...
public class SignInTest {
    ...
    public void signInTest() {
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.emailButton),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("harleymom5999@gmail.com"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.passWordButton),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("Checkers0509"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.username), withText("Brenda"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView.check(matches(withText("Brenda")));
    }
