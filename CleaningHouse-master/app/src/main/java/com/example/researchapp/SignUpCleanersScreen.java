...
public class SignUpCleanersScreen extends AppCompatActivity {
    String userName;
    String email;
    String confirm;
    String passWord;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_up_cleaners_screen);
                            ...
                            .addOnCompleteListener(SignUpCleanersScreen.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(SignUpCleanersScreen.this, "Account Successfully Created",
